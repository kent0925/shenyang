...
export const SealApprovalView: React.FC<Props> = ({ data, id = 'seal-approval-view' }) => {
  ...
  return (
    <div
      id={id}
      className="bg-white text-slate-900 p-4 sm:p-6 max-w-[760px] mx-auto text-xs leading-normal border border-slate-300 shadow-sm print:border-none print:shadow-none print:p-0 font-sans"
      style={{ boxSizing: 'border-box' }}
    >
      {/* 頁首公司抬頭 */}
      <div className="text-center mb-1">
        <h1 className="text-xl font-bold tracking-wider">{data.company || '昇陽開發實業股份有限公司'}</h1>
        <h2 className="text-base font-semibold tracking-widest mt-0.5">各項類別申請單</h2>
      </div>

      {/* 類別核取方塊 */}
      <div className="flex justify-center gap-14 py-1.5 mb-2 text-sm font-semibold border-y-2 border-slate-900">
      ...
      {/* 主表格 */}
      <table className="w-full border-collapse border-2 border-slate-900 mb-2 text-xs">
        <tbody>
          {/* 主旨與申請日 */}
          <tr className="border-b border-slate-900">
            <td className="w-20 bg-slate-100 font-bold px-2.5 py-1 text-center border-r border-slate-900 tracking-wider">
              主 旨
            </td>
            <td className="px-2.5 py-1 font-medium border-r border-slate-900">
              {data.subject || ''}
            </td>
            <td className="w-20 bg-slate-100 font-bold px-2.5 py-1 text-center border-r border-slate-900">
              申請日
            </td>
            <td className="w-36 px-2.5 py-1 text-center font-mono font-medium">
              {formattedDate}
            </td>
          </tr>
          ...
          <tr className="border-b border-slate-900 bg-slate-100">
            <td colSpan={4} className="font-bold px-3 py-0.5 text-center tracking-widest">
              說　　　　明
            </td>
          </tr>
            ...
            <td colSpan={4} className="p-0 align-top">
              <div className="divide-y divide-slate-200">
                {displayLines.map((line, idx) => (
                  <div key={idx} className="px-2.5 py-1 min-h-[22px] text-slate-800 whitespace-pre-wrap break-words">
                    {line}
                  </div>
                ))}
              </div>
          ...
          <tr className="border-t-2 border-slate-900">
            <td colSpan={2} rowSpan={2} className="p-1 border-r border-slate-900 text-[11px] text-slate-400"></td>
            <td className="bg-slate-100 font-bold px-2 py-0.5 text-center border-r border-slate-900 text-[11px]">
              印章借出簽收
            </td>
            <td className="px-2 py-0.5 text-center border-slate-900 h-5"></td>
          </tr>
          ...
          {/* 簽核空白格 */}
          <tr className="border-t border-slate-900 h-12">
          ...
          <tr className="border-t border-slate-900">
            ...
            <td className="text-[10px] text-slate-600 py-0.5 text-center border-slate-900">合約正本領取簽收</td>
          </tr>
          <tr className="border-t border-slate-900 h-4">
            <td colSpan={3} className="border-r border-slate-900"></td>
            <td className="border-slate-900"></td>
          </tr>
        </tbody>
      ...
      {/* 注意事項 */}
      <div className="text-[10.5px] text-slate-600 mb-1.5 leading-tight">
      ...
      <table className="w-full border-collapse border border-slate-900 text-[11px] text-center">
        <thead>
          <tr className="bg-slate-100 border-b border-slate-900 font-bold">
            <td className="p-0.5 border-r border-slate-900 w-1/3">財產編號(財務單位)</td>
            <td className="p-0.5 border-r border-slate-900 w-1/3">簽呈申請編號(歸檔單位)</td>
            <td className="p-0.5 w-1/3">用印申請編號(用印單位)</td>
          </tr>
        </thead>
        <tbody>
          <tr className="h-6">
